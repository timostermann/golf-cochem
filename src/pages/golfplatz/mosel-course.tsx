                ...
                <div className="mt-24 flex flex-col gap-8 md:flex-row">
                  <div className="flex flex-col gap-3">
                    ...
                    <p className="mt-8 max-w-[700px] text-lg text-gray-500">
                      Wenn Sie schon ein erfahrener Spieler sind, dann bietet
                      der überarbeitete 18-Loch-Golfplatz eine willkommene
                      Abwechslung. Der Platz wird täglich von professionellen
                      Greenkeeper mit Liebe zum Detail gepflegt und bietet
                      dadurch eine ausgezeichnete Qualität.
                      <br />
                      <br />
                      ...
                      Höhenunterschiede des 18-Loch Platzes bringen Sie
                      sicherlich sportlich wie technisch ins Schwitzen. <br />
                      <br />
                      Gerade Schläge helfen sicherlich für einen guten Score,
                      denn Schräglagen findet man ebenso, wie Rough
                      unterschiedlicher Höhen. Also aufgepasst, jeder Schlag
                      sollte sitzen! <br />
                      <br />
